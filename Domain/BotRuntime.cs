...
namespace Adminbot.Domain
{
    ...
    public static class TenantBotOrderKinds
    {
        ...
        /// <summary>
        /// A manual tenant card-to-card payment that increases the customer's shared wallet after owner approval.
        /// It never creates or renews an XUI account and never credits the tenant owner's wallet.
        /// </summary>
        public const string WalletCharge = "wallet_charge";
    }
    ...
    public static class WalletLedgerReasons
    {
        ...
        /// <summary>Credit mirrored to a tenant owner after a customer funds the shared wallet through a central platform gateway.</summary>
        public const string TenantWalletTopUpMirror = "tenant_wallet_topup_mirror";
        /// <summary>Strict local owner-wallet debit backing a tenant customer-wallet purchase or renewal.</summary>
        public const string TenantCustomerWalletBaseCost = "tenant_customer_wallet_base_cost";
        /// <summary>Compensation of a reserved owner base cost when the customer-wallet order is safely refunded.</summary>
        public const string TenantCustomerWalletBaseCostRefund = "tenant_customer_wallet_base_cost_refund";
