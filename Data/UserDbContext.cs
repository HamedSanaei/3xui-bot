...
public class UserDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AtlasPayPaymentInfo>(entity =>
        {
            ...
            entity.Property(x => x.WebhookEvent).HasMaxLength(64);
            // Automatic reconciliation lifecycle; defaults to active so legacy AtlasPay rows remain recoverable after migration.
            ...
            entity.HasIndex(x => new { x.WebhookReceivedAtUtc, x.WebhookProcessedAtUtc });
        });
